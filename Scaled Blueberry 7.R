...
#horizontal wildflower row below the blueberries
...
# n_bees=50      #scaled by 1/2 according to honeybee results
...
# png("Landscape6.png",width = 1024, height = 768)
image(x,y,field,col=c("grey85","yellow1","lightcyan"),asp=TRUE, axes=FALSE,main = "wild flowers below",cex.main=2,
      xlab="",ylab="")
points(nx,ny,pch=20,cex=2)
# dev.off()
