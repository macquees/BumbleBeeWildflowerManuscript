...
x_min_2 = 78   #blueberries to right of wildflowers
x_max_2 = 153  #blueberries to right of wildflowers
...
W_b = owin(xrange = c(0,152), yrange = c(75,225))    #the window for counting number of bees on a bush
ybreaks_b=75:225
...
left_edges_b = c(seq(x_min_1,x_max_1-2,3),seq(x_min_2,x_max_2-3,3))     #only the blueberry rows
...
# x = seq(x_min_1,x_max_2,.1)  #to evaluate the function
# y = seq(y_min,y_max,.1)
...
# image(x,y,field,col=c("grey85","yellow1","lightcyan"),asp=TRUE, axes=FALSE,main = "wild flowers centre",cex.main=2,
#       xlab="",ylab="")
# points(nx,ny,pch=20,cex=2)
# # dev.off()
